...
[
  ...
  {id: "0.9.35", date: "2003-8-27", condition: G,
   bugs: [156928, 161206],
   desc: "fixed the /list command when used without a <channel-name> " +
   "parameter."},
  {id: "0.9.34", date: "2003-8-26", condition: Y,
   bugs: [156928, 161206],
  ...
  {id: "0.9.33", date: "2003-8-25", condition: Y,
   bugs: [156928, 161206],
   desc: "prevents hidden views from coming back when you change your nick " +
   ":/"},
  {id: "0.9.32", date: "2003-8-25", condition: Y,
   bugs: [156928, 161206],
  ...
  {id: "0.9.28", date: "2003-8-16", condition: G,
  ...
  {id: "0.9.27", date: "2003-8-16", condition: Y,
   bugs: [103378, 115214, 116013, 117848, 119847, 121152, 126116, 133011,
          136528, 144053, 161206, 180873, 198548, 198823, 200413, 201504,
          204475, 206003, 206177, 206178, 207182, 207349, 208376, 211461,
          211518, 213037, 213097, 214591, 215730, 216018, 216120, 216202],
   ...
   "userlist."},
  {id: "0.9.26", date: "2003-8-15", condition: Y,
   bugs: [103378, 115214, 116013, 117848, 119847, 121152, 126116, 133011,
          136528, 144053, 161206, 180873, 198548, 198823, 200413, 201504,
          204475, 206003, 206177, 206178, 207182, 207349, 208376, 211461,
          211518, 213037, 213097, 214591, 215730, 216018, 216120, 216202],
   ...
   "the input box."},
  {id: "0.9.25", date: "2003-8-15", condition: Y,
   bugs: [103378, 115214, 116013, 117848, 119847, 121152, 126116, 133011,
          136528, 144053, 161206, 180873, 198548, 198823, 200413, 201504,
          204475, 206003, 206177, 206178, 207182, 207349, 208376, 211461,
          211518, 213037, 213097, 214591, 215730, 216018, 216120, 216202],
   desc: "fixes op/voice lights in older builds, <b>again</b>."},
  {id: "0.9.24", date: "2003-8-15", condition: Y,
   bugs: [103378, 115214, 116013, 117848, 119847, 121152, 126116, 133011,
          136528, 144053, 161206, 180873, 198548, 198823, 200413, 201504,
          204475, 206003, 206177, 206178, 207182, 207349, 208376, 211461,
          211518, 213037, 213097, 214591, 215730, 216018, 216120, 216202],
   desc: "is 0.9.23 merged with the 1.5b trunk."},
  {id: "0.9.23", date: "2003-8-15", condition: Y,
   bugs: [103378, 115214, 116013, 117848, 119847, 121152, 126116, 133011,
          136528, 144053, 161206, 180873, 198548, 198823, 200413, 201504,
          204475, 206003, 206177, 206178, 207182, 207349, 208376, 211461,
          211518, 213037, 213097, 214591, 215730, 216018, 216120, 216202],
   desc: "fixes the deleteOnPart pref."},
  {id: "0.9.22", date: "2003-8-15", condition: Y,
   bugs: [103378, 115214, 116013, 117848, 119847, 121152, 126116, 133011,
          136528, 144053, 161206, 180873, 198548, 198823, 200413, 201504,
          204475, 206003, 206177, 206178, 207182, 207349, 208376, 211461,
          211518, 213037, 213097, 214591, 215730, 216018, 216120, 216202],
  ...
  {id: "0.9.21", date: "2003-8-15", condition: Y,
   bugs: [103378, 115214, 116013, 117848, 119847, 121152, 126116, 133011,
          136528, 144053, 161206, 180873, 198548, 198823, 200413, 201504,
          204475, 206003, 206177, 206178, 207182, 207349, 208376, 211461,
          211518, 213037, 213097, 214591, 215730, 216018, 216120, 216202],
  ...
  {id: "0.9.20", date: "2003-8-15", condition: Y,
   bugs: [103378, 115214, 116013, 117848, 119847, 121152, 126116, 133011,
          136528, 144053, 161206, 180873, 198548, 198823, 200413, 201504,
          204475, 206003, 206177, 206178, 207182, 207349, 208376, 211461,
          211518, 213037, 213097, 214591, 215730, 216018, 216120, 216202],
  ...
  {id: "0.9.19", date: "2003-8-14", condition: Y,
  ...
  {id: "0.9.18", date: "2003-8-14", condition: Y,
   bugs: [210744, 133011, 198823, 213037, 215730, 216018, 216120, 216202],
   desc: "fixes some issues with tab focus."},
  {id: "0.9.17", date: "2003-8-14", condition: Y,
   bugs: [210744, 133011, 198823, 213037, 215730, 216018, 216120, 216202],
  ...
  {id: "0.9.12", date: "2003-7-19", condition: R, bugs: [210744, 198823],
  ...
  {id: "0.9.11", date: "2003-7-19", condition: R, bugs: [210744, 198823],
   desc: "fixes a few more pref bugs."},
  {id: "0.9.10", date: "2003-7-19", condition: R, bugs: [210744, 198823],
   desc: "fixes a bug that affected certain types of preferences."},
  {id: "0.9.9", date: "2003-7-19", condition: R, bugs: [210744, 198823],
   desc: "fixes some timing related issues with 0.9.8."},
  {id: "0.9.8", date: "2003-7-19", condition: R, bugs: [210744, 198823],
  ...
  {id: "0.9.7", date: "2003-7-18", condition: R, bugs: [210744, 198823],
  ...
  {id: "0.9.6", date: "2003-7-18", condition: R, bugs: [210744],
  ...
  {id: "0.9.5", date: "2003-7-17", condition: R, bugs: [210744],
  ...
  {id: "0.9.4", date: "2003-7-15", condition: R, bugs: [210744],
   desc: "makes context menus work when used over links, on Windows."},
  {id: "0.9.3", date: "2003-7-15", condition: R, bugs: [210744],
   desc: "fixes a problem updating the stalk list when you change " +
   "your nickname."},
  {id: "0.9.2", date: "2003-7-15", condition: R, bugs: [210744],
   ...
   "to the context menu."},
  {id: "0.9.1", date: "2003-7-13", condition: R, bugs: [210744],
   desc: "fixes a little regression with irc urls."},
  {id: "0.9.0", date: "2003-7-13", condition: R, bugs: [210744],
  ...
  {id: "0.8.34", date: "2003-6-21", condition: G,
  ...
  {id: "0.8.33", date: "2003-6-18", condition: Y,
   bugs: [80125, 114104, 198538, 200097, 114744, 200188, 199201, 202644,
          184228, 206915, 86526, 209524, 198823, 193246, 205792, 201324],
  ...
  {id: "0.8.29", date: "2003-5-04", condition: Y,
   bugs: [204348],
   desc: "<b>actually</b> fixes bug 204348"},
  {id: "0.8.28", date: "2003-5-03", condition: Y,
   bugs: [204348, 204347],
  desc: "fixes two regressions introduced in 0.8.27"},
  {id: "0.8.27", date: "2003-4-30", condition: Y,
   bugs: [119746],
  ...
  {id: "0.8.26", date: "2003-4-09", condition: G,
   ...
   "fixes."},
  {id: "0.8.25", date: "2003-3-25", condition: G,
  ...
  {id: "0.8.24", date: "2003-3-7", condition: Y,
  ...
  {id: "0.8.23", date: "2003-2-21", condition: G,
  ...
  {id: "0.8.22", date: "2003-2-16", condition: Y,
  bugs: [190210, 190777, 190568, 191910, 190532, 124638, 191500],
  desc: "fixes a problem where ChatZilla would linkify times."},
  {id: "0.8.21", date: "2003-2-15", condition: Y,
  bugs: [190210, 190777, 190568, 191910, 190532, 124638, 191500],
  ...
  "linked."},
  {id: "0.8.18", date: "2003-2-13", condition: Y,
  bugs: [190210, 190777, 190568, 191910, 190532, 124638],
  ...
  {id: "0.8.17", date: "2003-2-12", condition: Y,
  bugs: [190210, 190777, 190568, 191910, 190532, 124638],
  ...
  {id: "0.8.16", date: "2003-1-30", condition: Y,
  ...
  {id: "0.8.13b", date: "2003-1-30", condition: G,
  bugs: [190210, 190777],
  desc: "fixes the title of the pref panels, and a problem with the " +
  "pref listboxes."},
  {id: "0.8.13", date: "2003-1-23", condition: G,
  ...
  "scrolling problem."},
  {id: "0.8.12", date: "2003-1-22", condition: G,
  ...
  {id: "0.8.10", date: "2002-9-4", condition: G,
  ...
  {id: "0.8.9", date: "2002-8-8", condition: G, bugs: [133472, 131498],
  ...
  {id: "0.8.8", date: "2002-5-24", condition: G, bugs: [139334],
  desc: "adds the /squery command"},
  {id: "0.8.7", date: "2002-5-23", condition: G,
  ...
  {id: "0.8.4", date: "2001-8-23", bugs: [89713], condition: G,
  ...
  {id: "0.8.3", date: "2001-6-17", bugs: [27805], condition: G,
  ...
  {id: "0.8.2", date: "2001-6-6", bugs: [79311, 75226], condition: G,
  ...
  {id: "0.8.0", date: "2001-3-13", condition: G, bugs: [71468],
